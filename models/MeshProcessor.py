...
class MeshProcessor:
    ...
    def __init__(self, vertices, faces, ttype, from_file=False,
                 ...
                 compute_splu=True, load_splu=False, L=None):
        '''
        :param vertices:
        :param faces:
    ...
    def meshprocessor_from_array(vertices, faces, ttype, cpuonly=False, load_wks_samples=False,
                                 load_wks_centroids=False, L=None):
        return MeshProcessor(vertices, faces, ttype, cpuonly=cpuonly, load_wks_samples=load_wks_samples,
                             load_wks_centroids=load_wks_centroids, compute_splu=False, L=L)
    ...
    def compute_differential_operators(self):
        ...
        '''
        poisson_sys_mat = poisson_system_matrices_from_mesh(V=self.vertices, F=self.faces, cpuonly=self.cpuonly, L=self.L)
    ...
    def prepare_differential_operators_for_use(self):
